...
class ServiceOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_order" do
    assert_difference("ServiceOrder.count") do
      post service_orders_url, params: { service_order: { customer_id: @service_order.customer_id, description: @service_order.description, inventory_items_id: @service_order.inventory_items_id, pet_id: @service_order.pet_id, price: @service_order.price } }
    end
  ...
  test "should update service_order" do
    patch service_order_url(@service_order), params: { service_order: { customer_id: @service_order.customer_id, description: @service_order.description, inventory_items_id: @service_order.inventory_items_id, pet_id: @service_order.pet_id, price: @service_order.price } }
