class HospitalizationItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @hospitalization_item.save
        format.html { redirect_to hospitalization_item_url(@hospitalization_item), notice: "Hospitalization item was successfully created." }
  ...
  def update
    respond_to do |format|
      if @hospitalization_item.update(hospitalization_item_params)
        format.html { redirect_to hospitalization_item_url(@hospitalization_item), notice: "Hospitalization item was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to hospitalization_items_url, notice: "Hospitalization item was successfully destroyed." }
